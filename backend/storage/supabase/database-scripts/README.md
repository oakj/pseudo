...
| 3  | *_SelectQuestionsByUserId_* | user_id | question_id, question_title, question_difficulty, question_blob_url, question_leetcode_id, design_patterns, is_solved | Home | PK Only | Retrieves all questions with their design patterns and solved status for a specific user. | None |
